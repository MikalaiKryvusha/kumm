...
| Поле | Значение |
|------|----------|
| **Версия KAIF** | 2.5 — обновлено с 2.2 2026-09-05 (маршрут бутстрап; отчёт `reports/KAIF_UPDATES/KUMM_KAIF_2.5_UPDATE_REPORT.md`) |
...
История обновлений: 2.2 → 2.5, 2026-09-05, маршрут бутстрап, все счётчики боя совпали с песочницей.
Полевой отчёт — `reports/KAIF_UPDATES/KUMM_KAIF_2.5_UPDATE_REPORT.md`.
