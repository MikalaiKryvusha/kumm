...
> (принято 12.09) · **Статус:** ⏳ ждёт вычитки · **Цена ошибки:** низкая — правка строки и
...
## Таблица — 61 строка (23 с предложенным переводом, 38 помечены «не трогать»)

| № | EN | RU (предложение) | примечание |
|---|---|---|---|
| 240 |  +{0} XP  |  +{0} опыта  | всплывающая надпись за убийство · W_Kill_xp ×1 |
