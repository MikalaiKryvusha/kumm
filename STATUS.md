...
- 💡 **Идея 03 — атрибуты как в Морровинде, ЗАВЕДЕНА 12.09 (идея владельца).** «Чтобы герой с
      ...
      не с потолком — его уточнение. Разведка рычагов сделана:
      . **Редкий случай — кук НЕ нужен:** множители уже
      наружу (, , ,
      семейство ), высота прыжка — через  из Lua, а имена атрибутов игры
      найдены в её же таблицах ( и прочие). Первый шаг
      крошечный: прочитать из Lua значение ОДНОГО атрибута живого персонажа и напечатать в журнал.
      Одобрения не требует — идея его.
