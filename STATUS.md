...
- ❓ **Интервью #001 — каденция молитвы, 2026-09-05. Живым остался ОДИН вопрос (Q2):** полный текст
      молитвы перед каждой задачей (умолчание) или раз за сессию (выбор владельца в KAGO). Пока не
      отвечено — действует умолчание. Вопрос о метрике поставки (Q1) снят 18.09: KAIF 2.7 убрал учёт
      доставки словом владельца истока, строки `DELIVERY:` больше нет, блок метрики из `MASTER_PLAN.md`
      убран. Файл: `interviews/interview_001_delivery-metric.md`.
