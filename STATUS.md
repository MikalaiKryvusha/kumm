...
0. 🩺 **ЕСЛИ МОДЫ «НЕ РАБОТАЮТ» — ПЕРВЫМ ДЕЛОМ ОДНА КОМАНДА, а не поиск своей ошибки:**
   ...
   прямо над `GetMinAlignment`). Так выглядит файл, затёртый обновлением UE4SS на сборку БЕЗ
   исправления. ✅ **Апстрим принял нашу правку в тот же день** — коммит
   [`3fe75235`](https://github.com/UE4SS-RE/RE-UE4SS/commit/3fe752355dd240e09e50c6e4ad4524053da555c7)
   от 12.09, строка теперь в их штатном конанском конфиге; со сборки с этим коммитом она приезжает
   сама. Опасно только окно между нашей сборкой (main от 08.09) и первой сборкой с исправлением.
   Это самая вероятная причина возврата бага 10 (`bugs/10_DONE_*`, тикет
