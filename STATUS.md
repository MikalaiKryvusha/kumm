...
**Следующее по NVIDIA — два опыта из раздела «Awaiting human review» (замещение DLSS, RTX HDR).**
Порядок: сперва базовая пара захватов на нынешнем состоянии, потом ОДИН опыт, потом второй.
Предсказание объявлять до опыта, значение сверять мостом до и после захвата.
