...
2. **Лампочка «моды загружены» — ЗАКАЗ СНЯТ ВЛАДЕЛЬЦЕМ 09.09.2026.** Не воскрешать без его
   прямого слова. Причина: показ своего внутри игры не вышел — **пять способов из пяти уронили
   игру** (разбор с уликами до секунды — `ConanExiles/docs/06`, уроки `EXP-0060`, `EXP-0061`).
   Считалка модов работает и осталась: пишет «8 из 8» в журнал UE4SS. Мод жив и полезен другим —
   он гасит модалку «Играть без подключения» (заказ владельца, выполнен и проверен им же).
