...
0в. 🟢 **ИДЕЯ 03 — Проворство без потолка растит бег и прыжок. ПРОДОЛЖАТЬ ЗДЕСЬ.** Вайб: **«ничто не
   ...
   - 🟡 прыжок: JumpZ 840 → подъём 358 (420 → 87), падение с 3.6 м = −6 здоровья; игра иногда сбрасывает
     JumpZ на 420 (у умирающего героя через 8 с) — виновник не найден.

   **Дальше, атомарно:** (1) мод «Проворство → ступени перегруза»: форму роста показать владельцу
   вариантами на числах (Проворство 10/30/60/200), не выбирать самому; (2) переживает ли запись смерть и
   загрузку; (3) кто сбрасывает JumpZ — кит безоконно + здоровье в серию; (4) урон от падения растить с
   прыжком; (5) спринт синтетическим Shift не включается — причина открыта.
   ...
   **Зонд** `ConanExiles/_unpacked/ConanAttributeProbe` (раскатан): **Alt+Numpad .** — атрибуты и
   ...
   — ступени и прыжок x2; **Alt+Numpad /** — вернуть. ⚠️ **LeftAlt в Конане — уворот:** каждое нажатие
