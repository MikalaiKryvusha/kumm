...
- 🅿️ **Стрельба из лука «по-обливионски» — В ДАЛЬНЕМ ЯЩИКЕ по слову владельца 12.09 ~15:50.**
      ...
      не скажет.**
- 💡 **Идея 03 — атрибуты как в Морровинде, ЗАВЕДЕНА 12.09 (идея владельца).** «Чтобы герой с
      прокачкой Ловкости всё выше прыгал и быстрее бегал», рост **прогрессирующе бесконечный**, а
      не с потолком — его уточнение. Разведка рычагов — `ideas/03_conan_atributy_kak_v_morrowind.md`.
      ...
      **Шаг 1 ЗАКРЫТ 12.09 23:54: все шесть атрибутов сверены вживую** — очки вложены разным числом,
      зонд прочитал ровно то, что на экране (Сила 17 · Проворство 19 · Живучесть 14 · Выдержка 15 ·
      Мастерство 16 · Авторитет 27; брать FULL). **Следующий шаг — скорость бега от Проворства.**
      Разбор — конец `ideas/03_*`, урок `EXP-0097`. `ConanCharacter:GetIntStat(StatID, Mode)`; `ATTRIBUTE_ATHLETICISM`=19,
