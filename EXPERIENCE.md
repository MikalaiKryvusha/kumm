...
**Lesson:** совместимость версий пакетов проверяется ЧТЕНИЕМ двух заголовков, а не пробной варкой: образец «что игра принимает» — любой живой мод, образец «что пишет кит» — его собственные сохранённые ассеты.   → link: ideas/04 (Ш2) · plans/06 (фаза 1, риск (а))
